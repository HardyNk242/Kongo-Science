...
const LibraryView: React.FC = () => {
  ...
  // État pour la Pop-up de demande d'email (NOUVEAU)
  ...
  const MailRequestPopup = () => {
    ...
    // Lien spécial pour ouvrir Gmail dans le navigateur directement
      ...
      <div className="fixed inset-0 z-[60] flex items-center justify-center p-4 bg-black/50 backdrop-blur-sm">
        <div className="bg-white rounded-2xl shadow-2xl p-8 max-w-md w-full relative animate-fadeIn">
          ...
          <div className="space-y-3">
            {/* Option 1 : Ouvrir Gmail Web (Très utile si pas d'app mail) */}
            <a 
              href={gmailLink}
              target="_blank" 
            ...
            {/* Option 3 : Lien classique (pour ceux qui ont Outlook) */}
            <a 
              href={mailtoLink}
  ...
  if (selectedThesis) {
    return (
      <div className="bg-white min-h-screen pt-32 pb-20 px-6">
        {/* Affichage de la Pop-up si activée */}
  ...
  return (
    <div className="bg-white min-h-screen">
      ...
      {/* Affichage de la Pop-up si activée (au cas où on l'appelle ailleurs) */}
      {showMailPopup && <MailRequestPopup />}
