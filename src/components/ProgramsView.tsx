  ...
  const OffersView = () => {
    ...
    <div className="animate-in fade-in slide-in-from-bottom-4 duration-700 pb-20">
      ...
      <div className="max-w-7xl mx-auto px-6">
        ...
        {/* La remise membre n'a de valeur que si elle est vue au moment où le
            prix est lu. Sur le bouquet Premium, 10 % représentent 15 000 FCFA :
            l'adhésion à 6 500 est remboursée deux fois. */}
        <div className="mb-12 bg-amber-50 border border-amber-200 rounded-3xl p-6 flex flex-col sm:flex-row items-start sm:items-center gap-5">
          ...
          <div className="flex-grow">
            <h3 className="font-bold text-slate-900 mb-1">Membres : 10 % de réduction sur tous les bouquets</h3>
            <p className="text-sm text-slate-600 leading-relaxed">
              L'adhésion coûte <strong>6 500 FCFA par an</strong>. Sur le bouquet Premium,
              la remise représente <strong>15 000 FCFA</strong> — votre adhésion est remboursée
              plus de deux fois dès le premier accompagnement.
            </p>
          </div>
          <a
            href="/rejoindre"
            className="bg-slate-900 text-white px-6 py-3 rounded-xl font-bold text-sm hover:bg-blue-700 transition-colors whitespace-nowrap no-underline"
          >
            Adhérer
          </a>
        </div>
