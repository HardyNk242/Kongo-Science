...
const App: React.FC = () => {
  ...
  // âœ… Parse hash robuste: accepte "#registration/id" ET "#/registration/id"
  const syncFromHash = () => {
    const raw = window.location.hash || '';
    const cleaned = raw.replace(/^#\/?/, ''); // enlÃ¨ve "#", et aussi "#/"
    ...
    if (path === 'registration') {
      ...
      // âœ… si on quitte registration, on reset
      setSelectedConference(null);
    }
  };

  useEffect(() => {
    // âœ… Ã©couter hashchange (principal) + popstate (back/forward)
      ...
      case 'registration':
        return selectedConference ? (
          ...
          <div className="py-32 text-center">
            <h2 className="text-2xl font-bold">ConfÃ©rence non trouvÃ©e</h2>
            <p className="mt-2 text-slate-500">
              VÃ©rifie que lâ€™URL contient un id valide (ex: #registration/conf-peatlands).
            </p>
            <button
            ...
            <section className="py-20 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
              <div className="text-center mb-16">
                ...
                <p className="mt-8 text-slate-600 max-w-2xl mx-auto text-lg leading-relaxed">
                  Kongo Science Å“uvre pour l'Ã©veil de la conscience scientifique Ã  travers des piliers stratÃ©giques d'excellence souveraine.
                </p>
              </div>
